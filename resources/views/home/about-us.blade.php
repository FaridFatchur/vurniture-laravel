...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;700&family=Ubuntu:wght@700&display=swap" rel="stylesheet">
</head>
...
<body>
    ...
    <section class="about-us">
        <div class="about">
            <h1>About Us</h1>
            <p><b>vurniture</b> is an e-commerce website that facilitates its users to sell and shop for good quality used furniture. We realize that selling or finding used furniture with good quality and at the best prices is quite difficult, so by creating this website, we hope that users can easily sell and shop for used furniture while reducing the possibility of increasing the amount of furniture waste.</p>
        </div>
            ...
            <div class="members">
                ...
                <div class="member">
                    ...
                    <div class="ct-btn">
                        ...
                        <a href="#"><i class='bx bxl-linkedin' id="li-btn"></i></a>
                    </div>
                </div>
            </div>
        </div>
