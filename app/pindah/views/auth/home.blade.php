...
<body>
    ...
    <header class="header">
        ...
        <div class="btn">
            ...
            <a href="{{ asset('login') }}"><i class='bx bx-user' id="user-btn"></i></a>
    ...
    <section class="home">
        <div class="banner">
            ...
            <a href="{{ asset('home') }}#shop" class="shop-now-btn">Shop Now</a>
        </div>
    </section>
    ...
    <section class="shop" id="shop">
        ...
        <div class="row">
            <div class="catalog">
                <img src="{{ asset(img/catalog-bed.jpg) }}">
                <h3>Bed</h3>
                <h4>8.000.000 IDR</h4>
                <div class="atc-btn">
            ...
            <div class="catalog">
                <img src="{{ asset(img/catalog-chair.jpg) }}">
                <h3>Chair</h3>
                <h4>2.000.000 IDR</h4>
                <div class="atc-btn">
                    <a href="#">Add to Cart</a>
            ...
            <div class="catalog">
                <img src="{{ asset(img/catalog-sofa.jpg) }}">
                <h3>Sofa</h3>
                <h4>4.000.000 IDR</h4>
                <div class="atc-btn">
                    <a href="#">Add to Cart</a>
            ...
            <div class="catalog">
                <img src="{{ asset(img/catalog-table.jpg) }}">
                <h3>Table</h3>
                <h4>2.000.000 IDR</h4>
                <div class="atc-btn">
                    <a href="#">Add to Cart</a>
