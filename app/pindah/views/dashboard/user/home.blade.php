...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu top">
			<li>
				<a href="{{ asset('dashboard/user/home') }}">
					<i class='bx bxs-home'></i>
					<span class="text">Home</span>
				</a>
			</li>
			<li class="active">
				<a href="{{ asset('dashboard/user/myprofile') }}">
					<i class='bx bxs-user' ></i>
					<span class="text">My Profile</span>
				</a>
			</li>
			<li>
				<a href="{{ asset('dashboard/user/translist') }}">
					<i class='bx bxs-receipt' ></i>
					<span class="text">Transaction List</span>
				</a>
			</li>
			<li>
				<a href="{{ asset('dashboard/user/inbox') }}">
					<i class='bx bxs-message-dots' ></i>
					<span class="text">Inbox</span>
				</a>
			</li>
			<li>
				<a href="{{ asset('dashboard/user/wishlist') }}">
		...
		<ul class="side-menu">
			<li>
				<a href="{{ asset('dashboard/user/settings') }}">
					<i class='bx bxs-cog' ></i>
					<span class="text">Settings</span>
				</a>
			</li>
			<li>
				<a href="/vurniture/logout" class="logout">
	...
	<section id="content">
		...
		<nav>
			...
			<a href="{{ asset('dashboard/user/settings') }}" class="profile">
				<img src="{{ asset('img/profile-user.jpeg') }}">
			</a>
		</nav>
		<!-- NAVBAR -->
